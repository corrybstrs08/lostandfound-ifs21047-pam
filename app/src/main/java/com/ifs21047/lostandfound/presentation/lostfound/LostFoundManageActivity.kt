...
import com.ifs21047.lostandfound.helper.reduceFileImage
import com.ifs21047.lostandfound.helper.uriToFile
...
class LostFoundManageActivity : AppCompatActivity() {
    ...
    private fun manageEditLostFound(todo: LostFound) {
        binding.apply {
            appbarLostFoundManage.title = "Ubah Lost & Found"
    ...
    private fun observeAddCoverLost(
        todoId: Int,
    ) {
        val imageFile =
